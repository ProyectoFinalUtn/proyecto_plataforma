<?php
    ...
    class VantController extends REST_Controller
    {    
        public $responseOk;
        ...
        function __construct()
        {
            ...
            $this->methods['eliminar_vant_post']['limit'] = 500;// 100 requests per hour per user/key
        ...
        {   
            ...
            try{
                ...
                $vants = $this->Vant_model->obtener_vant_por_usuario($id_usuario);
                $this->set_respuesta($vants);
